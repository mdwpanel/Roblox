...
local ToolTab = Window:AddTab({ Name = "🛠️ Tools", Icon = "wrench" })
local CharTab = Window:AddTab({ Name = "👤 Character", Icon = "user" })
local TPTab = Window:AddTab({ Name = "📍 Teleport", Icon = "navigation" })
local UtilTab = Window:AddTab({ Name = "⚙️ Utility", Icon = "settings" })
...
local UpgradeSection = FishTab:AddSection("⚙️ Auto Upgrades")
...
local VisualSection = ToolTab:AddSection("👁️ Visual")
...
-- CHARACTER TAB UI
-- ============================================
local ProtectSection = CharTab:AddSection("🛡️ Protection")
...
-- UTILITY TAB UI
-- ============================================
local InfoSection = UtilTab:AddSection("ℹ️ Script Info")
